    ...
    >
          ...
          >
            ...
            <div>
              ...
              <ColorGrid>
                <ColorCard
                  name="Green Primary"
                  hex={colors.accent.green.primary}
                />
                <ColorCard
                  name="Green Button"
                  hex={colors.accent.green.button}
                />
                <ColorCard name="Red Primary" hex={colors.accent.red.primary} />
                <ColorCard name="Red Button" hex={colors.accent.red.button} />
                <ColorCard
                  name="Yellow Primary"
                  hex={colors.accent.yellow.primary}
                />
                <ColorCard
                  name="Yellow Light"
                  hex={colors.accent.yellow.light}
                />
              </ColorGrid>
            </div>
          </div>
      ...
      >
        ...
        <SubSection title="Cartes">
          ...
          >
            <div style={components.card.base}>
              ...
              >
                Carte avec les styles de base du design system. Utilisée pour
                grouper du contenu.
              </p>
            </div>
            <div
        ...
        <SubSection title="Indicateurs de Proxy">
          ...
          >
            {(
              ['idle', 'loading', 'success', 'error', 'cancelled'] as const
            ).map(status => (
              <div
                key={status}
                style={{
